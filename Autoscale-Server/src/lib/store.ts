...
import {
  ...
  DEFAULT_FACE_SWAP_MODEL_STRENGTH,
  ...
  normalizeFaceSwapModelStrength,
    ...
    boards: (rawStore.boards || []).map((board) => {
      ...
      return {
        ...
        settings: {
          ...
          upscaleFactor: normalizeUpscaleFactor((board.settings as { upscaleFactor?: unknown }).upscaleFactor),
          upscaleDenoise: normalizeUpscaleDenoise((board.settings as { upscaleDenoise?: unknown }).upscaleDenoise),
          ...
          faceSwapModelStrength: normalizeFaceSwapModelStrength((board.settings as { faceSwapModelStrength?: unknown }).faceSwapModelStrength),
...
function defaultBoardSettings(model: InfluencerModel): BoardSettings {
  ...
  return {
    ...
    upscaleDenoise: DEFAULT_UPSCALE_DENOISE,
    faceSwap: false,
    faceSwapModelStrength: DEFAULT_FACE_SWAP_MODEL_STRENGTH,
    autoPromptGen: false,
