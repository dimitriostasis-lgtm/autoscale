...
function normalizeBoardSettingsForBoardName(boardName: string, input: BoardSettingsInput): BoardSettings {
  ...
  return {
    ...
    upscaleFactor: normalizeUpscaleFactor(input.upscaleFactor),
    upscaleDenoise: normalizeUpscaleDenoise(input.upscaleDenoise),
    faceSwap: isFaceSwapWorkspaceLayout ? true : input.faceSwap,
    faceSwapModelStrength: normalizeFaceSwapModelStrength(input.faceSwapModelStrength),
