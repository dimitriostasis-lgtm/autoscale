...
function normalizeSettingsForGenerationModel(settings: BoardSettings, generationModel: string, workspaceSafety: "SFW" | "NSFW" = "SFW"): BoardSettings {
  ...
  return {
    ...
    autoPromptGen: promptUnsupported || isFaceSwapWorkspaceLayout ? false : settings.autoPromptImage ? true : settings.autoPromptGen,
...
function PlaygroundSurface({
  ...
  function updateGenerationModel(nextGenerationModel: string) {
    ...
    onSettingsChange({
      ...
      sdxlWorkspaceMode: nextSdxlWorkspaceMode,
      autoPromptGen: promptUnsupported ? false : settings.autoPromptImage ? true : settings.autoPromptGen,
...
export function ModelWorkspacePage({ slug, boardId, mode, onSelectBoard, onSelectMode }: ModelWorkspacePageProps) {
  ...
  function handleLayoutModeChange(nextSdxlWorkspaceMode: BoardSettings["sdxlWorkspaceMode"]) {
    ...
    void handleSettingsChange({
      ...
      autoPromptGen: nextIsFaceSwapWorkspaceLayout ? false : board.settings.autoPromptImage ? true : board.settings.autoPromptGen,
